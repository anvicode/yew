		...
		<div class="main-left col-span-3 space-y-4">
			...
			<div class="p-4 bg-white border border-gray-200 rounded-lg">
				...
				<p>
					...
					impedit corrupti dignissimos corporis, ducimus sit, dicta eveniet
					dolorum quas neque nulla, eligendi similique molestiae ut cupiditate
					necessitatibus. Quos, excepturi?
				</p>
